...
//		this(); // call same class, invoke non paramatrized of same class
	...
	public void cust_diplay() {
		System.out.println("inside cust_display in regular customer");
	}
	
	public void method() {
		this.cust_diplay(); // invoke this child class methid
		super.cust_diplay(); // invoke parent class method
		super.method(); //not mandotory first statement in method
